...
using Sagaway.RoutingTests.Logging;
...
public class SignalRWrapper : ISignalRWrapper
{
    ...
    private readonly List<string> _signalRMessagesReceived = new();
    ...
    async Task<bool> ISignalRWrapper.WaitForSignalREventWithConditionAsync(int timeoutInSeconds, Func<IReadOnlyList<string>, bool> condition)
    {
    ...
    IReadOnlyList<string> ISignalRWrapper.Messages
    {
        get
        {
            lock (_lock)
